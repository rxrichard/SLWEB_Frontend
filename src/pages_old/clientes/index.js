  ...
  render() {
    return (
      !this.state.loaded ? <Loading /> :
        ...
        <ToastContainer />
        <Datatable options={this.state.loaded} />
          <Titulo>
            <Campo
            ...
            <>
              <Combobox className='double'>
                ...
                <Campo>
                  ...
                  >
                    {this.state.usuarios[this.state.displayed].TPessoa ===
                    'J' ? (
                      <>
              ...
              <Combobox>
                <Campo>
                  ...
                  <TextInput
                    placeholder={
                      this.state.usuarios[this.state.displayed].Logradouro ||
                      'NA'
                    }
                    onChange={e =>
                      this.setState({
                ...
                <Campo>
                  ...
                  <TextInput
                    placeholder={
                      this.state.usuarios[this.state.displayed].Município ||
                      'NA'
                    }
                    onChange={e =>
                      this.setState({
              ...
              <Combobox>
                <Campo>
                  ...
                  <TextInput
                    placeholder={
                      this.state.usuarios[this.state.displayed]
                        .Contato_Empresa || 'NA'
                    }
                    onChange={e =>
                      this.setState({
                ...
                <Campo>
                  ...
                  <TextInput
                    value={this.converterData(
                      this.state.usuarios[this.state.displayed].DtSolicita ||
                        'NA'
                    )}
                    readOnly
                  />
                ...
                <Campo>
                  ...
                  <TextInput
                    value={this.converterData(
                      this.state.usuarios[this.state.displayed].DtCadastro ||
                        'NA'
                    )}
                    readOnly
                  />
